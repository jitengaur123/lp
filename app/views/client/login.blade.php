            ...
            <div class="col-md-12">
                <div class="login-box">
                   ...
                   <div class="login-form">
                        ...
                        <form id="form-login" action="{{ url('client/login') }}" method="post" class="form-horizontal ls_form">
                            <div class="input-group ls-group-input">
                                <input class="form-control" placeholder="Email" name="user_name" type="text" autofocus>
