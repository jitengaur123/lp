...
@section('content')
      <div class="row">
          <div class="col-md-12"> 
            ...
            <h3 class="ls-top-header">Add New Magnet Board</h3>
            <!--Top header end --> 
            <!--Top breadcrumb start -->
            
            <ol class="breadcrumb">
              <li> <a class="fa fa-home" href="#"></a> </li>
              <li class="active">Add New Magnet Board</li>
            </ol>
            <!--Top breadcrumb start --> 
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="panel panel-default userform no-border">
              <div class="panel-heading ">
                <h3 class="panel-title">Add New Magnet Board In This Section</h3>
              ...
              <div class="panel-body">
                <p>You can add new Magnet Board in this section by filling appropriate fields. The worklocation id is an autogenerated field which can not be altered.</p>
