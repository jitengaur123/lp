                ...
                <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-info-circle"></i> Work Report Number (Autogenerated)</label>
                               <input class="form-control" disabled placeholder="Work Report Number" name="job_number" type="text" value="{{ $reports['job_number'] }}">
                            </div>
                        ...
                        <div class="col-md-12"><!--section 1 starts here-->
                            ...
                            <div id="entry1" class="clonedInput row"><!--clonedinput starts-->
                                ...
                                <fieldset class="col-md-3 col-md-6"><!--entry 1-->
                                    ...
                                    <select id="labor" class="demo-default form-control laborOptions" name="labour_id[]" placeholder="Select Employee...">
