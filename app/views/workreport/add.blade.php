                ...
                <div class="panel-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" disabled placeholder="Job Number" name="job_number" type="text" value="AMA-JB-4187">
                            </div>
