...
@section('content')
      <div class="row">
          <div class="col-md-12"> 
            ...
            <h3 class="ls-top-header">Export Magnet Board</h3>
            <!--Top header end --> 
            <!--Top breadcrumb start -->
            
            <ol class="breadcrumb">
              <li> <a class="fa fa-home" href="#"></a> </li>
              <li class="active">Export Magnet Board</li>
            </ol>
            <!--Top breadcrumb start --> 
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="panel panel-default userform no-border">
              <div class="panel-heading ">
                <h3 class="panel-title">Export Magnet Board In This Section</h3>
              ...
              <div class="panel-body">
                ...
                <form class="ls_form" id="magnetForm" method="get" action="{{ URL::to(Config::get('constants.PREFIX').'/export/magnet') }}">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{ URL::to(Config::get('constants.PREFIX').'/export/magnet') }}" class="btn ls-light-blue-btn" type="submit"> <i class="fa fa-cloud-upload"></i> Export All</a>
...
<title>Amaha - Export Magnet</title>
