        ...
        <table>
            <tbody>
                <tr>
                    ...
                    @foreach($worksites as $worksite)
                    <td width="200px" height="True" valign="top" style="cursor:default;">
                        <ul id="job{{ $worksite->id }}" data-worksiteid="{{ $worksite->id }}" data-jobid="{{ $worksite->m_id }}" class="connectedSortable sortableUl ui-sortable "  style="list-style-type:none;padding:0px;width:200px;background:#fff;height:3000px;">
