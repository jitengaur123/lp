...
<div class="row">
          <div class="col-md-12"> 
            ...
            <h3 class="ls-top-header">Edit/Delete Work Report</h3>
            <!--Top header end --> 
            <!--Top breadcrumb start -->
            
            <ol class="breadcrumb">
              <li> <a class="fa fa-home" href="#"></a> </li>
              <li class="active">Edit Or Delete  Work Report</li>
            </ol>
            <!--Top breadcrumb start --> 
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="panel panel-default userform no-border">
              <div class="panel-heading">
                <h3 class="panel-title">Edit Or Delete Registered  Work Report</h3>
              </div>
              ...
              <form method="post" onsubmit="return confirm('Are you sure want to delete?');">
                <!--Select Box Start-->
                   <div class="row">
                    <div class="col-md-6">
                        <h3 class="ls-header">Select & search from registered  Work Report</h3>
                        <p>You can search and select from available  Work Report on this application and perform the actions of editing or deleting their profile</p>
                            <div class="control-group">
                                <select id="select-country" name="id" class="demo-default id" placeholder="Select a  Work Report...">
                                    <option value="">Select a  Work Report...</option>
                                    @foreach($workreports as $report)
                                    <option value="{{ $report['id'] }}">{{ $report['job_number'] }}</option>
                                   @endforeach
                                </select>
                                <input type="hidden" class="editUrl" value="{{ URL::to($prefix . '/workreport/') }}" >
                                <span class="help_text">Select One  Work Report</span>
                            </div>
                    </div>
                    <div class="col-md-6 padtop100">
                       <!--action buttons-->
                       <div class="col-md-3"><button type="button" class="btn ls-light-blue-btn editSelectedData">Edit Selected  Work Report</button></a></div>
                       <div class="col-md-3"><button type="submit" class="btn btn-danger deleteSelected confirmBox marginl25">Delete Selected  Work Report</button></div>
                       <!--action buttons end-->
                    </div>
                </div>
                </form> 
...
<title>Amaha - Edit/Delete  Work Report</title>
